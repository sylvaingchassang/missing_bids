...
print('rough tolerance T^2: {}'.format(
    4. / tsuchiura_before_min_price.df_bids.shape[0]))
...
for min_markup in [.4]:
    constraints = [
        ...
        environments.InformationConstraint(
           k=2, sample_demands=multistage_demands_fc_before)
    ]
    ...
    share = min_collusion_solver.result.solution
    print('{} | share non collusive: {}'.format(min_markup, 1 - share))
